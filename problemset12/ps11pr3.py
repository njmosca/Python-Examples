...
#description: ps11 problem 3, importing all data class inforamtion including methods
...
def get_age_on(birthday,other):
    ''' takes in birthday and other date, assuming other will be on or after birthday'''

    days = other.days_between(birthday)
    return days //365
   


def print_birthdays(filename):
    ''' reads in txt file and returns  each name and birthday'''
    ...
    for line in file:
        ...
        print(name,'('+str(date)+')','('+str(date.day_name())+')')
